...
final class StreamSOAP11Decoder extends StreamSOAPDecoder{
    ...
    //    return new StreamMessage(headers, reader, SOAPVersion.fromNsUri(SOAPConstants.URI_NS_SOAP_1_1_ENVELOPE));
            return new StreamMessage(envelope,envelopeNSDecls,envAttrs,soapHeader,soapHeaderNSDecls,shAttrs,headers, reader, soapBody,bodyNSDecls,bodyAttrs,SOAPVersion.fromNsUri(SOAPConstants.URI_NS_SOAP_1_1_ENVELOPE));
    }   
}