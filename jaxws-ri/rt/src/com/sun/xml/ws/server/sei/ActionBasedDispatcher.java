...
class ActionBasedDispatcher implements EndpointMethodDispatcher {
    ...
    protected final @NotNull AddressingVersion av;

    private final Map<String, EndpointMethodHandler> actionMethodHandlers;

    public ActionBasedDispatcher(SEIModel model, WSBinding binding, InvokerSource invoker, EndpointMethodDispatcherGetter owner, EndpointMethodHandlerFactory factory) {
    	this(model, binding, invoker, false, owner, factory);
    }
    
    protected ActionBasedDispatcher(SEIModel model, WSBinding binding, InvokerSource invoker, boolean isResponseProcessor, EndpointMethodDispatcherGetter owner, EndpointMethodHandlerFactory factory) {
    ...
    protected EndpointMethodHandler getEndpointMethodHandler(String action) throws DispatchException {
