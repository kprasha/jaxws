...
public class EndpointFactory {
    ...
    public <T> WSEndpoint<T> createEndpoint(
        ...
        return createEndpoint(serviceName, portName, binding,container,seiModel,wsdlPort,implType, serviceDefiniton,terminal, isTransportSynchronous, policyMap);
    }
    ...
    protected <T> WSEndpoint<T> createEndpoint(@NotNull QName serviceName, @NotNull QName portName, WSBinding binding,
            ...
            PolicyMap policyMap) {
    	return new WSEndpointImpl<T>(serviceName, portName, binding, this, container, seiModel, port, implementationClass, serviceDef, terminalTube, isSynchronous, policyMap);
    }
    
    public <T> WSEndpoint<T> createSpliceEndpoint(@NotNull QName serviceName, @NotNull QName portName, WSBinding binding,
            Container container, SEIModel seiModel, WSDLPort port,
            Tube masterTubeline, Tube postSpliceTube) {
    	return new WSEndpointImpl<T>(serviceName, portName, binding, container, this, seiModel, port, masterTubeline, postSpliceTube);
    }

    public <T> WSEndpoint<T> createSpliceEndpoint(WSEndpoint<T> endpoint,
            SEIModel seiModel, Tube masterTubeline, Tube postSpliceTube) {
    	return new WSEndpointImpl<T>(endpoint, this, seiModel, masterTubeline, postSpliceTube);
    }
