 ...
 */
final class EndpointMethodHandlerImpl implements EndpointMethodHandler {
    ...
    private final InvokerSource source;

    public EndpointMethodHandlerImpl(InvokerSource source, JavaMethodImpl method, WSBinding binding, EndpointMethodDispatcherGetter emd) {
        this.source = source;
        this.soapVersion = binding.getSOAPVersion();
        this.method = emd.getHandlerMethod(method);
    ...
    */
    ...
    public Packet invoke(Packet req) {
        ...
        try {
            Object ret = source.getInvoker(req).invoke(req, method, args);
    ...
    public Packet invoke(Throwable t) {
    	Message responseMessage = SOAPFaultBuilder.createSOAPFaultMessage(soapVersion, null, t);
    	Packet req = Fiber.current().getPacket();
        return req.createServerResponse(responseMessage, req.endpoint.getPort(), javaMethodModel.getOwner(), req.endpoint.getBinding());
    }
