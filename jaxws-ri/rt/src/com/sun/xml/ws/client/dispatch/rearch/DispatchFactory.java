...
public interface DispatchFactory<T> {
     ...
     */
    public Dispatch createDispatch(QName port, Class<T> clazz, Service.Mode mode, Object delegate);
   ...
   */
   ...
   public static final DispatchFactory<SOAPMessage> SOAP_DISPATCH_FACTORY = new DispatchFactory<SOAPMessage>() {
        ...
        public Dispatch createDispatch(QName port, Class<SOAPMessage> clazz, Service.Mode mode, Object obj) {
            return (Dispatch) new SOAPMessageDispatch(port, clazz, mode, obj);
        }
    };
    ...
    public static final DispatchFactory<DataSource> DATASOURCE_DISPATCH_FACTORY = new DispatchFactory<DataSource>() {
        ...
        public Dispatch createDispatch(QName port, Class<DataSource> clazz, Service.Mode mode, Object obj) {
            return (Dispatch) new DataSourceDispatch(port, clazz, mode, obj);
        }
    };
    ...
    public static final DispatchFactory<Source> SOURCE_DISPATCH_FACTORY = new DispatchFactory<Source>() {
        ...
        public Dispatch createDispatch(QName port, Class<Source> clazz, Service.Mode mode, Object obj) {
            return (Dispatch) new SourceDispatch(port, clazz, mode, obj);
        }
    };    
}
