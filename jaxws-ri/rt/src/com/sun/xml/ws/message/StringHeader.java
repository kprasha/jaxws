...
public class StringHeader extends AbstractHeaderImpl {
    ...
    public XMLStreamReader readHeader() throws XMLStreamException {
        try {
            ...
            XMLStreamWriter writer = buf.createFromXMLStreamWriter();
    ...
    public void writeTo(ContentHandler contentHandler, ErrorHandler errorHandler) throws SAXException {
        TagInfoset tis = new TagInfoset(name.getNamespaceURI(), name.getLocalPart(), name.getPrefix(), new AttributesImpl());
        tis.writeStart(contentHandler);
        tis.writeEnd(contentHandler);
    }
}
